...
import com.dlsd.property.adapters.AllOrderAdapter;
...
public class AllOrderActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mIndex = 1;
        mOrderAdapter = new AllOrderAdapter(AllOrderActivity.this, mOrderDatas);
...
//        });
    ...
    private void showSendDialog(Order order, int state) {
        AlertDialog dialog = new AlertDialog(AllOrderActivity.this).builder();
