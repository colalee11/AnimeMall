...
import com.dlsd.property.merchants.activitys.GoodsByTypeActivity;
import com.dlsd.property.merchants.activitys.GoodsDetailActivity;
    ...
    protected void init() {
        ...
        mMainTypeAdapter.setOnItemClickListener(new MainTypeAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClicked(MainTypeAdapter adapter, int position) {
                ...
                intent.putExtra("goodsType", mTypeDatas.get(position)); //传递类对象
