...
import com.dlsd.property.guard.activitys.GoodsManagerActivity;
import com.dlsd.property.guard.activitys.GoodsTypeManagerActivity;
 ...
 * 商家首页HomeFragment
 */
public class GuardMainFragment extends BaseFragment implements View.OnClickListener {

    private FragmentGuardMainBinding mBinding;
    private ArrayList<Integer> mBannerUrl;

    public static GuardMainFragment newInstance() {
        GuardMainFragment fragment = new GuardMainFragment();
